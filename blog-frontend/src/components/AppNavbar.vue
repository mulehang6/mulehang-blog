    ...
    <div class="container mx-auto px-4 py-4">
      <div class="flex h-14 items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          <!-- 搜索按钮 -->
          <Button variant="ghost" size="icon" class="hidden md:flex" @click="showSearchDialog = true">
          ...
          <template v-if="!userStore.isLoggedIn">
            ...
            <Button @click="router.push('/register')" variant="default" size="sm" class="hidden md:flex">
              注册
            </Button>
          </template>
            ...
            <div class="relative" ref="userMenuRef">
              ...
              >
                <Avatar class="h-8 w-8">
                  ...
                  <AvatarFallback>{{ userStore.userInfo?.nickname?.charAt(0) || 'U' }}</AvatarFallback>
                </Avatar>
              </Button>
              ...
              >
                <div class="py-1">
                  <div class="px-4 py-3 border-b">
                    <p class="text-sm font-medium">{{ userStore.userInfo?.nickname }}</p>
                    <p class="text-xs text-muted-foreground">{{ userStore.userInfo?.email }}</p>
                  </div>
                  <button
