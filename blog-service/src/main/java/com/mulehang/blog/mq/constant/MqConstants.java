 ...
 * </ul>
 *
 * <p><b>消息流转路径（帮你理解 RabbitMQ 的核心概念）</b>：</p>
 * <pre>
 *   Producer
 *      │
...
public final class MqConstants {
     ...
     *
     * <p>upsert = update or insert，表示"有则更新、无则新增"</p>
     */
     ...
     * 文章 upsert 路由键。
     *
     * <p>Producer 发消息时指定这个 routingKey，Exchange 会把消息路由到 ARTICLE_UPSERT_QUEUE</p>
     */
     ...
     *
     * <p>当业务队列里的消息被 nack 且不重新入队时，会被转发到这里</p>
     */
     ...
     * 死信队列。
     *
     * <p>所有"处理失败"的消息最终都会堆积在这里，方便排查问题</p>
     */
